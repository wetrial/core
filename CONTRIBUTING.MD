...
这篇指南会指导你如何为 `@wetrial/core` 贡献一份自己的力量，请在你要提 issue 或者 pull request 之前花几分钟来阅读一遍这篇指南。

## 透明的开发

我们所有的工作都会放在 [GitHub](https://github.com/wetrial/core) 上。不管是核心团队的成员还是外部贡献者的 pull request 都需要经过同样流程的 review。
...
然后你可以基于 [contribute_template](https://github.com/wetrial/core/tree/master/contribute_template) 来初始化一个 Hook。
...
1. `npm start` 在本地运行 `@wetrial/core` 网站。
